...
public class User implements UserDetails, Serializable{
	...
	@ManyToMany(fetch = FetchType.EAGER)//EAGER carreguei user tambem vai carregar as permissoes
	...
	//porque implementamos UserDetails precisamos fazer a conversao de permissions para roles
